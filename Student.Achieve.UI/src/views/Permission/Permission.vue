    ...
    <section>
            ...
            <el-table-column prop="IsAuth" label="是否权限" width="100" sortable>
                <template slot-scope="scope">
                    <el-tag
                            ...
                            disable-transitions>{{!scope.row.IsAuth ? "否":"是"}}
                    </el-tag>
                </template>
            </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" v-model="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
                ...
                <el-form-item prop="IsAuth" label="是否权限" width="" sortable>
                    <el-switch v-model="editForm.IsAuth" >
                    </el-switch>
                </el-form-item>
        ...
        <el-dialog title="新增" :visible.sync="addFormVisible" v-model="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
                ...
                <el-form-item prop="IsAuth" label="是否权限" width="" sortable>
                    <el-switch v-model="addForm.IsAuth" >
                    </el-switch>
                </el-form-item>
                <el-form-item prop="IsHide" label="隐藏菜单" width="" sortable>
