    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters" @submit.native.prevent>
                ...
                <el-form-item>
                    <el-button type="primary" @click="getCourse">查询</el-button>
                </el-form-item>
                <el-form-item>
        ...
        <!--列表-->
        <el-table :data="Course" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
                  style="width: 100%;">
            ...
            <el-table-column label="操作" width="150">
                <template scope="scope">
                    ...
                    <el-button type="danger" size="small" @click="deleteCourse(scope.$index, scope.row)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-col :span="24" class="toolbar">
            ...
            <el-pagination layout="prev, pager, next" @current-change="nextPageCourse" :page-size="50"
                           :total="total" style="float:right;">
            </el-pagination>
        </el-col>

        <!--新增界面-->
        <el-dialog title="新增课程" :visible.sync="addFormVisible" v-model="addFormVisible" :close-on-click-modal="false">
        ...
        <!--编辑界面-->
        <el-dialog title="编辑课程" :visible.sync="editFormVisible" v-model="editFormVisible" :close-on-click-modal="false">
...
<script>
    ...
    import {addCourse,getCourseListPage,removeCourse,editCourse} from '../../api/api';
        ...
        methods: {
            ...
            getCourse() {
                ...
                getCourseListPage(para).then((res) => {
                    ...
                    this.Course = res.data.response.data;
