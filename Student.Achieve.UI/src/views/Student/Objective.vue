<template>
  <section>
     <el-menu
      class="el-menu-demo"
      default-active="/Student/Objective"
      mode="horizontal"
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters" @submit.native.prevent>
        ...
        <el-form-item>
          <el-button type="primary" @click="getObjectiveStudent">查询</el-button>
        </el-form-item>
      </el-form>
    </el-col>

    <!--列表-->
     <el-table :data="ObjectiveStudent"   
    ...
    <el-col :span="24" class="toolbar">
      <el-pagination
        ...
        @current-change="nextPageObjectiveStudent"
        :page-size="50"
        :total="total"
        style="float:right;"
      ></el-pagination>
...
export default {
  ...
  methods: {
    ...
    nextPageObjectiveStudent(val) {
      this.page = val;
      this.getObjectiveStudent();
    },
    getExamTreeFunc() {
    ...
    getObjectiveStudent() {
      ...
      getObjectiveStudent(para).then(res => {
        
        this.cols =JSON.parse(res.data.response.Header);
        this.ObjectiveStudent = JSON.parse(res.data.response.Content);
